...
const Sidebar = ({isMenuOpen, setIsMenuOpen}) => {
  ...
  return (
    <div
      ...
      {/* Logo */}
         <img
        src={assets.logo_full} // Always use the normal logo for white mode
        alt="QuickGPT Logo"
      ...
      cursor-pointer'>
        <span className='mn-2 text-xl'>+</span> New Chat
      </button>
...
<label className='relative inline-flext cursor-pointer'>
 <input onChange={()=>setTheme(theme==='dark'?'light':'dark')} 
   ...
   peer-checked:bg-purple-600 transiton-all'>
...
{user && <img src={assets.logout_icon} className='h-5 cursor-pointer
hidden not-dark:invert group-hover:block'/>}
</div>
